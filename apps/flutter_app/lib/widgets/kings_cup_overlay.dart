...
class KingsCupOverlay extends StatefulWidget {
  const KingsCupOverlay({
    super.key,
    required this.card,
  ...
  @override
  State<KingsCupOverlay> createState() => _KingsCupOverlayState();
}

class _KingsCupOverlayState extends State<KingsCupOverlay>
  ...
  Widget build(BuildContext context) {
    return Container(
      key: const Key('kings-cup-overlay'),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${_remainingSeconds}s',
                      key: const Key('kings-cup-countdown'),
                      style: Theme.of(context)
                          .textTheme
                          .headlineSmall
                          ?.copyWith(
