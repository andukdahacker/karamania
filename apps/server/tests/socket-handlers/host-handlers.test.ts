...
describe('host-handlers', () => {
  ...
  describe('host:skip', () => {
    it('validates host and calls processDjTransition with HOST_SKIP', async () => {
      ...
      expect(mockProcessDjTransition).toHaveBeenCalledWith('session-1', context, { type: 'HOST_SKIP' });
    });
  ...
  describe('host:override', () => {
    it('validates host and calls processDjTransition with HOST_OVERRIDE', async () => {
      ...
      expect(mockProcessDjTransition).toHaveBeenCalledWith('session-1', context, { type: 'HOST_OVERRIDE', targetState: 'ceremony' });
    });
  ...
  describe('host:songOver', () => {
    it('validates host, checks song state, and calls processDjTransition with SONG_ENDED', async () => {
      ...
      expect(mockProcessDjTransition).toHaveBeenCalledWith('session-1', context, { type: 'SONG_ENDED' });
    });
