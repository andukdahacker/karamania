...
- **Reactive phone light show:** Phone screens pulse color synced to song energy — soft glow during verses, bright fast pulses during choruses, synchronized strobe during peak energy moments. Replaces lightstick mode with a music-reactive experience that requires zero user interaction
...
- **FR66:** Reactions and hype signals are available alongside the lyrics display — participants interact without leaving the lyrics screen
